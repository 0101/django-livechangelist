...
(function() {
  ...
  django.jQuery(function($) {
    ...
    pk_row_mapping = (function() {
      ...
      var a, mapping, pk, tr, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          a = _ref1[_j];
          pk = (_ref2 = pk_href_re.exec($(a).attr('href'))) != null ? _ref2[1] : void 0;
          if (pk) {
            mapping[pk] = $(tr);
            break;
          }
      ...
      for (pk in data) {
        ...
        _results.push((function() {
          ...
          for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
            td = _ref[i];
            if (should_update(td)) {
              _results1.push($(td).html($(cells[i]).html()));
            }
          }
          return _results1;
        })());
